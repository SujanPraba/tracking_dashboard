  ...
  return (
    <>
      ...
      <button
        ...
        className="xl:hidden fixed top-4 left-4 z-50 p-2 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700"
      >
        {isMobileOpen ? (
      ...
      {isMobileOpen && (
        <div
          className="xl:hidden fixed inset-0 bg-black bg-opacity-50 z-40 backdrop-blur-sm"
